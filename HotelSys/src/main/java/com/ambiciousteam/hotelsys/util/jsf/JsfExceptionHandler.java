...
import com.ambiciousteam.hotelsys.exceptions.BusinessException;
...
//    Recebe o tratador de exceções do JSF através da atribuição do construtor da classe
    ...
    public void handle() {
        ...
        while (eventos.hasNext()) {
            ...
            BusinessException negocioException = getNegocioException(excecao);
            ...
            try {
                ...
                if (excecao instanceof ViewExpiredException) {
                    ...
                    handled = true;
                    FacesUtil.errorMessage(negocioException.getMessage());
                } else {
                    handled = true;
